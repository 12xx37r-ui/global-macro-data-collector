...
def main():
    ...
    payload={
      'schema_version':'1.0.0','patch_version':'V218-live-refetch-contract','generated_at_utc':datetime.now(timezone.utc).isoformat(),
      'bundle_generated_at_utc':bundle.get('generated_at_utc'),'compatibility':{'existing_keys_removed':False,'existing_field_semantics_changed':False,'new_network_calls':0,'network_refetch_each_workflow':True,'http_cache_bypass':True,'model_formulas_changed':False},
